...
the only way to override the presenter since it is provided by the "real" MainModule is to take advantage of build flavours, as implenented in [Android testing codelab](https://codelabs.developers.google.com/codelabs/android-testing/#0).
